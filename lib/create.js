                    ...
                    return Promise.all(currentLevels.map(function(relLevel) {
                        ...
                        return config.level(level).then(function(levelOptions) {
                            ...
                            return Promise.all(currentTechs.map(function(tech) {
                                ...
                                var isPipedR = template instanceof stream.Readable,
                                    contentR = (isPipedR || typeof template === 'string') ? template :
                                        template(entity, bemNaming(levelOptions.naming));

                                // console.log('absPathToFile', absPathToFile);
                                // console.log('contentR', contentR);
                                return createEntity(absPathToFile, contentR, levelOptions);
                            }));
                        });
                    }));
